...
namespace HospitalManager.API.Migrations
{
    ...
    [Migration("20241217175115_EmailAddRequiredAndUniqe")]
    partial class EmailAddRequiredAndUniqe
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HospitalManager.API.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5350),
                            Specialization = "Všeobecný lekár",
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5351)
                        },
                        new
                        {
                            Id = 2,
                            BirthNumber = "012345/1236",
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5354),
                            Specialization = "Detský lekár",
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5355)
                        });
                });
            ...
            modelBuilder.Entity("HospitalManager.API.Entities.Examination", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5443),
                            DoctorId = 1,
                            ExaminationDate = new DateTime(2024, 11, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5435),
                            PatientId = 2,
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5444)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5448),
                            DoctorId = 2,
                            ExaminationDate = new DateTime(2025, 2, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5446),
                            PatientId = 1,
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5449)
                        });
                });
            ...
            modelBuilder.Entity("HospitalManager.API.Entities.Medicine", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5488),
                            ...
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5489)
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5493),
                            ...
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5493)
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5559),
                            Name = "Ibuprofen",
                            Price = 6.25m,
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5560)
                        });
                });
            ...
            modelBuilder.Entity("HospitalManager.API.Entities.Patient", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5397),
                            DoctorId = 1,
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5397)
                        },
                        new
                        {
                            Id = 2,
                            BirthNumber = "012345/1237",
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5400),
                            DoctorId = 2,
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5400)
                        });
                });
            ...
            modelBuilder.Entity("HospitalManager.API.Entities.Recipe", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5607),
                            ExaminationId = 1,
                            Expiration = new DateTime(2025, 1, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5603),
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5607),
                            Used = 0
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5611),
                            ExaminationId = 2,
                            Expiration = new DateTime(2025, 2, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5610),
                            UpdatedAt = new DateTime(2024, 12, 17, 17, 51, 14, 240, DateTimeKind.Local).AddTicks(5612),
                            Used = 1
                        });
                });
